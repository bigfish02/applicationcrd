...
import (
	...
	scheme "github.com/bigfish02/applicationcrd/pkg/generated/clientset/versioned/scheme"
...
type ApplicationInterface interface {
	...
	Apply(ctx context.Context, application *applicationv1.ApplicationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Application, err error)
...
func newApplications(c *XiaohongshuV1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *applications) Apply(ctx context.Context, application *applicationv1.ApplicationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Application, err error) {
	if application == nil {
